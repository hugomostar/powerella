      ...
      <Container className="mt-9">
        <div className="max-w-2xl">
          ...
          <p className="mt-6 text-base text-zinc-600 dark:text-zinc-400">
            Inspired by the spirit of Poverello, Powerella Pilgrim empowers
            women to discover their inherent strength through humble faith and
            meaningful spiritual journeys.
          </p>
